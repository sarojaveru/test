...
setwd("C:/Users/Saroja/Downloads")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputId = "subset_income", label = "Select Income Category",
      ...
      selectInput(inputId = "set_yaxis", label = "Y-Axis",
                  choices = c(hours_per_week = "hours_per_week", 
                              capital_loss = "capital_loss")),
      # Interactive piece 3: inputId = "subset_occupation"
      checkboxGroupInput(inputId = "subset_occupation", label = "Occupation",
